...
public class CloneGraph_133 {
    ...
    private Node fun1(Node node) {
        ...
        Node currentNode = currentNode = new Node(node.val);
        tempMap.put(currentNode.val, currentNode);
        for (Node tempNode : node.neighbors) {
            currentNode.neighbors.add(fun1(tempNode));
        }
        return currentNode;
    }
