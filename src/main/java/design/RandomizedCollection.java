 ...
 * <p>
 * 来源：力扣（LeetCode） 链接：https://leetcode-cn.com/problems/insert-delete-getrandom-o1-duplicates-allowed
...
/**
 * Your RandomizedCollection object will be instantiated and called as such: RandomizedCollection obj = new
 * RandomizedCollection(); boolean param_1 = obj.insert(val); boolean param_2 = obj.remove(val); int param_3 =
 * obj.getRandom();
 */
