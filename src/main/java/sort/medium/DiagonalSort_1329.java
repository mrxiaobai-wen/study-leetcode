...
public class DiagonalSort_1329 {
    ...
    private void sort(int[][] arr,int startRow,int startCol,int endRow,int endCol) {
        for (int i = endRow - 1,j = endCol - 1;i > 0 && j > 0;i--,j--) {
            for (int k = startRow,m = startCol;k < i && m < j;k++,m++) {
