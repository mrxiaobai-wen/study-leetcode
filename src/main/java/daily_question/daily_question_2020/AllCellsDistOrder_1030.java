 ...
 * <p>
 * 输入：R = 2, C = 2, r0 = 0, c0 = 1 输出：[[0,1],[0,0],[1,1],[1,0]] 解释：从 (r0, c0) 到其他单元格的距离为：[0,1,1,2]
 * [[0,1],[1,1],[0,0],[1,0]] 也会被视作正确答案。 示例 3：
 * <p>
 * 输入：R = 2, C = 3, r0 = 1, c0 = 2 输出：[[1,2],[0,2],[1,1],[0,1],[1,0],[0,0]] 解释：从 (r0, c0) 到其他单元格的距离为：[0,1,1,2,2,3]
...
public class AllCellsDistOrder_1030 {
    ...
    public int[][] allCellsDistOrder(int R, int C, int r0, int c0) {
        return fun(R, C, r0, c0);
    }

    private int[][] fun(int r, int c, int r0, int c0) {
